...
router.get('/bookings/:id', Authentication.verify_token, Bookings.get_user_booking);
router.delete('/bookings/:id', Authentication.verify_token, Bookings.deleteBooking);
